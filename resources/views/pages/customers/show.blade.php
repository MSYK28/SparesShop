    ...
    <div class="container">
        <div class="container mb-3">
            <nav aria-label="breadcrumb mb-4">
                ...
                <h6 class="font-weight-bolder mb-0 text-capitalize">Information about <span class="supplier_name">{{ $customer->name }}</span></h6>
            </nav>
        </div>
                    ...
                    <form id="addCustomerForm" class="row g-3" action="{{ route('customers.transactions') }}"
                        ...
                        <div class="col-12 col-md-12 fv-plugins-icon-container">
                            ...
                            <input type="text" id="name" name="name" class="form-control"
                                placeholder="John Doe" readonly value="{{ $customer->name }}">
