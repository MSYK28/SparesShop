                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-7">
                                            <label class="form-label" for="customer_name">Name</label>
                                            <input type="text" id="customer_name" name="customer_name"
                                                class="form-control" readonly value="{{ $order->suppliers->name }}">
                                        </div>
                                        <div class="col-12 col-md-3">
                                            <label class="form-label" for="orders">0rders</label>
                                            {{-- <h6 class="text-body text-nowrap mb-0">Orders: {{ $customer->orders()->count() }}</h6> --}}
                                    ...
                                    <div class="col-md-12 mt-2">
                                        ...
                                        <input type="text" id="customer_name" name="customer_name"
                                            class="form-control" readonly value="{{ $order->suppliers->email }}">
                                    </div>
                                </div>
                            @endif
                                ...
                                <form id="addCustomerForm" class="row g-3" action="{{ route('sales.store') }}"
                                    ...
                                    @if ($order->status == 1)
                                        <div class="d-flex justify-content-center align-items-center">
                                            ...
                                            <h6 class="m-0"><a href=" javascript:void(0)" data-bs-toggle="modal"
                                                data-bs-target="#addCustomerModal" class="btn btn-success me-sm-3 me-1">Receive Order</a></h6>
                ...
                <div class="modal-dialog modal-lg modal-simple modal-edit-user">
                    <div class="modal-content p-3 p-md-5">
                        <div class="modal-body">
                            ...
                            <form id="addCustomerForm" class="row g-3" action="{{ route('orders.store') }}"
                                method="POST">
                                @csrf
                                <table class="table table-responsive table-bordered table-striped">
                                        ...
                                        @foreach ($order_details as $order_detail)
                                            <tr>
                                                <td>{{ $order_detail->products->productTitle }}
                                                    <input type="hidden" class="form-control product_id" name="product_id[]" id="product_id" value="{{ $order_detail->product_id }}"  required>
                                                </td>
                                                <td>{{ $order_detail->quantity }}</td>
                                                <td>
                                                    <input type="text" class="form-control order_quantity_received" name="quantity_received[]" id="order_quantity_received" required>
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control order_price" name="price[]" id="order_price" required>
                                                </td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <input type="hidden" class="form-control" name="order_id" id="order_id" value="{{ $order->id }}" required>
